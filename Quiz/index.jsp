  ...
  <div class="nav-block">
    ...
    <div class="slider">
      <div class="slide active">
        <h1>"Success is not determined by the number of questions you answer correctly in a quiz competition, but by the knowledge you gain along the way."</h1>
      </div>
      <div class="slide">
        <h1> "In a quiz competition, every question is an opportunity to expand your horizons and learn something new."</h1>
      </div>
      <div class="slide">
        <h1>"Participating in a quiz competition is not just about winning; it's about challenging yourself and pushing the boundaries of your knowledge."</h1>
      </div>
      <div class="slide">
        <h1> "A quiz competition is like a mental workout, where your brain gets stronger with every question you tackle."</h1>
      </div>
      <div class="slide">
        <h1>"Quiz competitions remind us that learning is a lifelong journey, and every question is an opportunity to embark on a new adventure." </h1>
      </div>
    </div>
    ...
    <footer>
      ...
      <div class="social-media">
        <div class="imgcover">
          <a href="https://twitter.com" target="_blank"><img src="img/twitter.webp" alt="Twitter" style="opacity: 0.8;"></a>
        </div>
        ...
        <div class="imgcover">
          <a href="https://facebook.com" target="_blank"><img src="img/facebook.png" alt="Facebook" style="opacity: 0.8;"></a>
        </div>
