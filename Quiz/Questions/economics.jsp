...
<body>
 ...
 <div class="rules" id="rules">
  ...
  <%@ page import="java.util.ArrayList" %>
    <%
        String questionType = "Economic"; 
        String selectedOption = request.getParameter("selectedOption");
        

        // Declare ArrayLists outside of the scriptlet
        ...
        try {
            ...
            String sql = "SELECT * FROM questions WHERE question_type = ? ORDER BY RAND() LIMIT ?";

            int numberOfQuestionsToFetch = 10;

            pst = con.prepareStatement(sql);

            pst.setString(1, questionType);   
